...
{
    public class AppCheckAttribute: ActionFilterAttribute
    {


        private readonly string[] noCheckingSessionActions_=[
            "/app/user/wx-mp-login"
            ];
        ...
        {
            string? signature = context.HttpContext.Request.Headers["App-Signature"];
            string? timestamp = context.HttpContext.Request.Headers["App-Timestamp"];
            string? sessionId = context.HttpContext.Request.Headers["App-Session"];
            string? requestId= context.HttpContext.Request.Headers["App-RequestId"];
            context.HttpContext.Response.Headers["App-RequestId"] = requestId;
